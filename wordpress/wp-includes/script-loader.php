...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->add( 'prototype', '/wp-admin/js/google/prototype.js', array(), '1.7.1');
	$scripts->add( 'scriptaculous-root', '/wp-admin/js/google/scriptaculous.js', array('prototype'), '1.9.0');
	$scripts->add( 'scriptaculous-builder', '/wp-admin/js/google/builder.js', array('scriptaculous-root'), '1.9.0');
	$scripts->add( 'scriptaculous-dragdrop', '/wp-admin/js/google/dragdrop.js', array('scriptaculous-builder', 'scriptaculous-effects'), '1.9.0');
	$scripts->add( 'scriptaculous-effects', '/wp-admin/js/google/effects.js', array('scriptaculous-root'), '1.9.0');
	$scripts->add( 'scriptaculous-slider', '/wp-admin/js/google/slider.js', array('scriptaculous-effects'), '1.9.0');
	$scripts->add( 'scriptaculous-sound', '/wp-admin/js/google/sound.js', array( 'scriptaculous-root' ), '1.9.0' );
	$scripts->add( 'scriptaculous-controls', '/wp-admin/js/google/controls.js', array('scriptaculous-root'), '1.9.0');
